...
# Set to false to Show item info to the right of the icons on the desktop
...
# Bottom Right
defaults write com.apple.dock wvous-nr-corner -int 4
defaults write com.apple.dock wvous-nr-modifier -int 0
